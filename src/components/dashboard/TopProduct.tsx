...
export function TopProduct() {
  ...
  const ProductCard: Component = useMemo(
    () => () => {
      return (
        <Card placeholder='' className='h-full w-5/6 max-w-[48rem] flex-row h-70'>
          ...
          <CardBody placeholder='' className='h-full'>
            ...
            <Typography placeholder='' color='gray' className='font-normal h-20 overflow-hidden'>
              ...
              sapiente reprehenderit error natus libero deserunt ducimus quasi fuga expedita
              consequatur blanditiis sit voluptatum consequuntur incidunt, dolorem iusto debitis
              numquam?
            </Typography>
          </CardBody>
        </Card>
