...
export function AdminDashboard() {
  return (
    <div className='grid lg:grid-cols-12 gap-5'>
      <Card className='lg:col-span-5 h-96 p-3 flex flex-col items-center'>
        <Typography variant='h5'>Thống kê sản phẩm theo danh mục</Typography>
        <CategoryChart data={data} />
      </Card>
      <Card className='lg:col-span-7 h-96 p-3 flex flex-col items-center'>
        <div className='grid grid-cols-2 justify-items-center items-center w-full mb-3'>
          <Typography variant='h5'>Thống kê sản phẩm được upload</Typography>
          <Select label='Select Period'>
      ...
      <Card className='lg:col-span-5 h-96 p-3 flex flex-col items-center gap-10'>
        <Typography variant='h5'>Top sản phẩm bán chạy</Typography>
        <TopProduct />
      </Card>
      <Card className='lg:col-span-7 h-96 p-3 flex flex-col items-center'>
        <div className='grid grid-cols-2 justify-items-center items-center w-full mb-3'>
      ...
      <Card className='lg:col-span-12 h-96 p-3 flex flex-col items-center'>
        <div className='grid grid-cols-2 justify-items-center items-center w-full mb-3'>
